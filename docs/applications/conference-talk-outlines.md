...
- The governance corpus (~879K+ words) is evidence of capability
...
- The governance corpus (~879K+ words), the registry, the schemas
...
| Documentation volume | ~879K+ words | system metrics |
