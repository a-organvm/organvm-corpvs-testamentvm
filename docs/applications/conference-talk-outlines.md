...
- Root cause: 104 workflows running on every push across 127 repos
...
4. **Slide 13:** Run `organvm seed validate` — show the system verifying its own structural integrity across 127 repos.
...
| Metric | Value | Source |
|--------|-------|--------|
| Total repositories | 127 | registry-v2.json |
