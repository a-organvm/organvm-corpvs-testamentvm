...
- ~879K+ words of documentation across the system
...
- **What works:** "Developer education" explicitly qualifies you — 11 years teaching + ~879K+ words of documentation. Founding-team aspect means culture-shaping, which favors unconventional backgrounds. The role is documentation-first, not engineering-first.
...
- **What works:** Documentation volume and quality are proven (~879K+ words, 42 essays). Self-directed operator. Writing quality. Remote-first. HuggingFace hires 30–40% from community — unconventional backgrounds are normal.
