...
5. **Communication** — Can the artist articulate their practice? (~879K+ words, 42 essays, process documented in real-time)
...
**Why you fit:** MacDowell values sustained creative work across all disciplines. The organ system is exactly the kind of practice that benefits from uninterrupted deep work time. The documentation corpus (~879K+ words) demonstrates capacity for the intensive production MacDowell enables.
...
2. **Solo production at institutional scale.** One person coordinating 105 repositories through documented governance, using AI tools as compositional instruments. 33 named sprints, ~879K+ words, 96+ CI/CD workflows — the system is evidence this mode of production works.

3. **5+ years of sustained practice.** This isn't a proposal — it's an ongoing body of work requesting a context (the residency) to deepen and share. 33 development sprints, ~879K+ words, fully operational.
