...
2. **Systemic thinking** — Does the artist think beyond individual pieces? (Governance model, dependency graph, state machine, editorial vision across 118 repos)
...
**Why you fit:** Perfect fit — free, Brooklyn-based, self-directed. The organ system is exactly the kind of ambitious creative-technical project RC values. The 118-repo governance infrastructure would be a fascinating RC project.
...
>
> **Summary:** During this residency, I will [SPECIFIC DELIVERABLES] within the context of my ongoing eight-organ creative-institutional system — a documented infrastructure coordinating 118 repositories across theory, art, commerce, governance, and community.
>
...
2. **Solo production at institutional scale.** One person coordinating 118 repositories through documented governance, using AI tools as compositional instruments. 33 named sprints, ~404K+ words, 105+ CI/CD workflows — the system is evidence this mode of production works.
