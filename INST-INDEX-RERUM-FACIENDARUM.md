...
| IRF-III-017 | **P1** | **sovereign-systems: Content genome merge pass — reduce 1,821 fine-grained atoms to ~1,000 build-ready merge groups.** Three-way verification (Claude/Gemini/Claude-blind) confirmed same ideas but our decomposition over-splits prompt/response pairs. Need `merge_group` field added to adjacent atoms sharing a topic. Strike plans should reference merge groups. Routing map at `docs/archive/atom-routing-map.md`. | Agent | S-2026-04-03 atomic excavation | None |
