...
| IRF-APP-029 | P2 | Content engine: registry-v2.json + ORGAN-III submodule — remainder of IRF-APP-002. Repo exists and is now ACTIVE (seed.yaml updated), but not registered in registry or superproject. Invisible to system tooling | Agent | Session S37 (IRF-APP-002 remainder) | None |
